const siteConfig = {
  siteTitle: 'Fire HTML5',
  website: 'fire-core.netlify.app',
  ...
  nav: [
    ...
    {
      text: 'About',
      url: 'https://fire-core.netlify.app/index.html?p=about',
    },
    {
      text: 'About',
      url: 'https://fire-core.netlify.app/index.html?p=contact',
    },
  ],
  footer: [
    {
...
function build_menu(config, page) {
  ...
  innerMoreWrapper.classList.add(
    'flex',
    'items-center',
    'justify-between',
    'h-16'
...
function build_mobile_menu(config, page) {
  ...
  innerWrapperColor.classList.add(
    'flex',
    'flex-col',
    'h-full',
    'divide-y',
...
function build_footer(config) {
  ...
  logoInnermostWrapper.classList.add(
    'flex',
    'justify-center',
    'text-teal-300',
    'lg:justify-start'
